  ...
  return (
    <div className={`container ${styles.sectionContainer}`}>
      ...
      <div className={`row`}>
        ...
        <ProjectSectionCard
          linkUrl="https://github.com/Pascal-Bliem/doggo-snap"
        ...
        <ProjectSectionCard
          linkUrl="https://github.com/Pascal-Bliem/tox-block"
        ...
        <ProjectSectionCard
          linkUrl="https://github.com/Pascal-Bliem/diarysta"
        ...
        <ProjectSectionCard
          linkUrl="https://github.com/Pascal-Bliem/european-social-survey"
        ...
        <ProjectSectionCard
          linkUrl="https://github.com/Pascal-Bliem/error-control-statistical-tests"
        ...
        <ProjectSectionCard
          linkUrl="https://anchor.fm/suara-jermanesia"
