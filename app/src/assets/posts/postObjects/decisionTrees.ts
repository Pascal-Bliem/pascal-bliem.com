...
export default new Post(
  // title
  "Effectiveness of Decision Tree Ensembles",
  // subtitle
  "Why tree-based algorithms perform so well on real-world tabular data",
  // publishDate
  new Date("2024-09-09"),
  // titleImageUrl
  "https://pb-data-blogposts.s3.eu-central-1.amazonaws.com/effectiveness-of-decision-tree-ensembles/decision_tree_forest.png",
  // titleImageDescription
  "Sometimes you just can't see the forest for the Decision Trees.",
  // tags
