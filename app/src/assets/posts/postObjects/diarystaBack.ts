...
export default new Post(
  ...
  ["Web Development"],
  // content
  `**TL;DR**: I built a diary app called Diarysta in which you can track your daily moods and activities and get a graphical summary of your personal diary-stats. It is a MERN stack (MongoDB, Express, React, Node.js) application and in this blog post, I will discuss the design and implementation of the back end. There will be another post on the frontend/user interface soon. You can visit a demo of the app [here](https://diarysta.onrender.com/) and also have a look at its [Github repo](https://github.com/Pascal-Bliem/diarysta).
